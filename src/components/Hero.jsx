    ...
    <section className="relative overflow-x-hidden overflow-y-hidden bg-[#f7f2e9] font-serif">
      ...
      <div className="relative z-10">
        ...
        <div className="relative min-h-[76vh] overflow-hidden md:min-h-[82vh]">
          <div className="mx-auto flex min-h-[76vh] max-w-[1440px] flex-col justify-center px-4 pb-8 pt-[116px] md:min-h-[82vh] md:px-8 md:pt-[148px]">
            <div className="overflow-hidden rounded-[34px] border border-white/12 bg-[linear-gradient(135deg,rgba(31,21,14,0.7),rgba(31,21,14,0.44))] shadow-[0_35px_120px_rgba(10,7,5,0.35)] backdrop-blur-[8px]">
              <div className="grid min-h-[58vh] items-center gap-10 px-6 py-10 text-white md:min-h-[64vh] lg:grid-cols-[1.3fr_1fr_1fr] lg:gap-8 md:px-12 md:py-14 lg:px-14">
                <div className="text-center md:text-left">
                  <p
                    className={`text-[0.78rem] uppercase tracking-[0.38em] text-[#ead7a3] transition-all duration-300 md:text-[0.92rem] ${showHeroText
                  ...
                  <h1
                    className={`mt-5 text-[2.7rem] font-normal leading-[1.05] tracking-[-0.03em] transition-all duration-300 sm:text-[3.8rem] md:text-[4.6rem] lg:text-[4.8rem] ${showHeroText
                        ? "translate-y-0 opacity-100"
                        : "translate-y-6 opacity-0"
                      }`}
                  >
                  ...
                  <div
                    className={`mt-8 h-px w-28 bg-[rgba(234,215,163,0.72)] transition-all duration-300 md:w-36 ${showHeroText
                        ? "translate-y-0 opacity-100"
                        : "translate-y-6 opacity-0"
                      } mx-auto md:mx-0`}
                  />
                  ...
                  <p
                    className={`mt-8 max-w-2xl text-lg leading-[1.8] text-white/82 transition-all duration-300 md:text-[1.2rem] ${showHeroText
                        ? "translate-y-0 opacity-100"
                        : "translate-y-6 opacity-0"
                      }`}
                  >
                ...
                <div
                  className={`rounded-[28px] border border-white/10 bg-[rgba(255,248,238,0.08)] p-6 text-left text-white/90 shadow-[0_20px_60px_rgba(0,0,0,0.18)] transition-all duration-300 md:p-8 ${showHeroText
                      ? "translate-y-0 opacity-100"
                      : "translate-y-6 opacity-0"
                    }`}
                >
                  <p className="text-[0.8rem] uppercase tracking-[0.28em] text-[#ead7a3] font-semibold">
                    Our Calling
                  </p>
                  <p className="mt-5 text-[1.1rem] leading-[1.8] font-light md:text-[1.18rem]">
                  ...
                  <div className="mt-8 flex flex-wrap gap-4">
                    <Link
                      to="/donate"
                      className="rounded-full border border-[#d1b06d] bg-[#d1b06d] px-7 py-3.5 text-sm font-semibold uppercase tracking-[0.24em] text-[#24170d] transition hover:bg-[#e2c98d] hover:shadow-[0_8px_25px_rgba(209,176,109,0.3)]"
                    >
                      Donate
                    </Link>
                    <Link
                      to="/gallery"
                      className="rounded-full border border-white/25 bg-[rgba(255,255,255,0.04)] px-7 py-3.5 text-sm font-semibold uppercase tracking-[0.24em] text-white transition hover:border-[#ead7a3] hover:text-[#ead7a3]"
                    >
                      View Gallery
                    </Link>
                  </div>
                ...
                <div
                  className={`rounded-[28px] border border-[#d1b06d]/20 bg-[rgba(209,176,109,0.06)] p-6 text-left text-white/90 shadow-[0_20px_60px_rgba(0,0,0,0.18)] transition-all duration-300 md:p-8 flex flex-col items-center text-center ${showHeroText
                      ? "translate-y-0 opacity-100"
                      : "translate-y-6 opacity-0"
                    }`}
                >
                  ...
                  <div className="relative mt-4 h-48 w-48 shrink-0">
                    <svg
                      viewBox="0 0 100 100"
                      className="-rotate-90 h-full w-full drop-shadow-[0_12px_28px_rgba(209,176,109,0.25)]"
                    >
                      <circle
                        cx="50"
                        cy="50"
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <p className="text-[1.8rem] font-semibold leading-none text-[#ead7a3]">
                        {overallProgress.toFixed(1)}%
                      </p>
                      <p className="mt-1 text-[0.65rem] uppercase tracking-[0.18em] text-white/60">
                        Funded
                      </p>
                    </div>
                  </div>

                  <div className="mt-4 w-full rounded-2xl bg-[rgba(255,255,255,0.04)] border border-white/5 p-4 space-y-1">
                    <div className="flex justify-between items-center">
                      <span className="text-[1.4rem] text-white/80 font-medium tracking-wide">Goal</span>
                      <span className="text-[1.15rem] font-semibold text-white/95">
                        ₹4,00,00,000
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-[1.4rem] text-white/80 font-medium tracking-wide">Collected</span>
                      <span className="text-[1.15rem] font-bold text-[#ead7a3]">
                        ₹74,53,134.25
                      </span>
                    </div>
                  </div>
